...
def main():
    ...
    try:
        ...
        #~ boolean trigger for LEFT JOIN between transactions and products.
        ...
        #~ so we want to add those brackets to avoid
    ...
    #! cust + date + store     //no product
    #! product + date + store  //no cust
    #! cust + product + store  //no date
